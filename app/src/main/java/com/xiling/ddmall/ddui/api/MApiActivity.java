package com.xiling.ddmall.ddui.api;
...
import com.xiling.ddmall.ddui.activity.CashWithdrawActivity;
import com.xiling.ddmall.ddui.activity.DDCommunityActivity;
import com.xiling.ddmall.ddui.activity.SelectAddressMapActivity;
import com.xiling.ddmall.ddui.activity.SharePosterActivity;
import com.xiling.ddmall.ddui.bean.DDCouponBean;
import com.xiling.ddmall.ddui.bean.DDHomeBean;
import com.xiling.ddmall.ddui.bean.WithdrawStatusBean;
import com.xiling.ddmall.ddui.custom.D3ialogTools;
import com.xiling.ddmall.ddui.custom.DDCouponSelectorDialog;
import com.xiling.ddmall.ddui.custom.DDResultDialog;
import com.xiling.ddmall.ddui.manager.AppUpgradeManager;
import com.xiling.ddmall.ddui.manager.CommunityImageMaker;
import com.xiling.ddmall.ddui.tools.DLog;
import com.xiling.ddmall.ddui.tools.TextTools;
import com.xiling.ddmall.dduis.bean.DDHomeDataBean;
import com.xiling.ddmall.dduis.bean.DDHomeRushDataBean;
import com.xiling.ddmall.dduis.dialog.DDGeneralDialog;
...
import com.xiling.ddmall.shared.service.contract.IPageService;
...
public class MApiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addRootEvent(new ApiEvent() {
            ...
            @Override
            public boolean onEvent() {
                APIManager.startRequest(mHomeService.getHomeData(), new RequestListener<DDHomeDataBean>() {
                    @Override
                    public void onStart() {
        ...
        adapter.addRootEvent(new ApiEvent() {
            ...
            @Override
            public boolean onEvent() {
                APIManager.startRequest(mHomeService.getHomeRushData(), new RequestListener<DDHomeRushDataBean>() {
        ...
        adapter.addRootEvent(new ApiEvent() {
            ...
            @Override
            public boolean onEvent() {
                new DDCouponSelectorDialog(MApiActivity.this, Arrays.asList(new DDCouponBean(), new DDCouponBean()))
                        .show();
                return true;
            }
        });

//        buildUserDataProtocol();
//
//        buildDrawCashInfo();
